...
def test_rtmt_msg_e_motor_data():
    check_data((
...
def test_rtmt_msg_extrema_data():
    check_data((
...
def test_rtmt_msg_warnings_data():
    check_data((
...
def test_rtmt_msg_cell_volts_data():
    check_data((
...
def test_rtmt_msg_probe_temps_data():
    check_data((
